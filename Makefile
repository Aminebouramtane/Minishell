...
SRC = main.c lexer/main_lexer.c lexer/check_slpit.c lexer/utils.c lexer/delimiters/qoutes.c lexer/delimiters/parentheses.c lexer/delimiters/input_output.c \
	...
	parce/utils.c parce/utils2.c parce/utils3.c parce/utils4.c  execution/execution.c execution/builtin1_echo.c execution/builtin2_cd.c \
	...
	execution/heredoc/ex_node.c execution/heredoc/ex.c execution/shlvl.c
